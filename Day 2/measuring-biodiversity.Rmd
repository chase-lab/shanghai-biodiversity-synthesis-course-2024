...
![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2/figs/coral quadrat.png)   
Or use a line intercept transect of a set length (e.g., 50m).

![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2/figs/coral transect.png)


Then, choose a metric...but, there are *lots* to choose from!


![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2/figs/magurran2004.jpg){width=50%}
![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2/figs/magurran&mcgill.jpg)

![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2/figs/mcgill_2010_table9.3.png)
...
biodiversity scales non-linearly [refs]. The individual-based rarefaction curve
is often limited because with sufficient 
sampling effort on the x-axis, the curve cab bend upwards again (e.g., 
triphasic SAR, [@rosenzweig_species_1995]. The nonlinear scaling of 
...
Here we will approach the scale-dependence of biodiversity using an approach
introduced by @whittaker_vegetation_1960 that considers two discrete spatial 
scales and another to relate the two. Specifically, the larger (sometimes 
...
where $\beta$-diversity describes the variation among samples (or sites or time
points) in species composition.  
...
as coming from the $\alpha$-scale. And then combine multiple samples to create
the $\gamma$-scale.
...
effectively a random subsample of the larger ($\gamma$) scale. This makes sense, 
because we know that the individuals of all species were distributed randomly 
in space. Before diving into some beta-diversity metrics, let's look at how 
