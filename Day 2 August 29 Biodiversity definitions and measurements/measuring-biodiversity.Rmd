...
![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2 August 29 Biodiversity definitions and measurements/figs/coral quadrat.png)   
Or use a line intercept transect of a set length (e.g., 50m).

![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2 August 29 Biodiversity definitions and measurements/figs/coral transect.png)


Then, choose a metric...but, there are *lots* to choose from!


![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2 August 29 Biodiversity definitions and measurements/figs/magurran2004.jpg){width=50%}
![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2 August 29 Biodiversity definitions and measurements/figs/magurran&mcgill.jpg)

![](/Users/sb25gaqy/Dropbox/4teaching/shanghai-biodiversity-synthesis-course-2024/Day 2 August 29 Biodiversity definitions and measurements/figs/mcgill_2010_table9.3.png)
...
By making scale discrete, we can continue to use the individual-based 
rarefaction to visualise and describe biodiversity. We'll consider each sample
...
# simulate a community with 200 species and 5000 individuals, and 
# a lognormal SAD, and individuals aggregated in space
Spool <- 200
Jpool <- 5000
...
This is due to within species aggregation. Environmental heterogeneity is 
ubiqutious in nature - environmental conditions are typically more similar when
in close proximity, either in space or time. This heterogeneity, and other processes,
often result in
species exhibiting varying degrees of within species aggregation. So, 
...
@mcglinn_measurement_2019-1]. Changes in any (and all) of these components underpin
